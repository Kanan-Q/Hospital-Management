...
//    // RequestDelegate-in düzgün inject edilməsi
//    public IpRestrictionMiddleware(RequestDelegate next, ILogger<IpRestrictionMiddleware> logger)
//    {
//        _next = next;  // RequestDelegate avtomatik inject olunur
//        _logger = logger;
...
//        string myIp = "192.168.1.71"; // Öz IP-nizi buraya əlavə edin
//        if (!_allowedIps.Contains(myIp)) _allowedIps.Add(myIp);

//        _logger.LogInformation($"Loaded allowed IPs: {string.Join(", ", _allowedIps)}");
//    }

//    // Gələn sorğuları yoxlamaq üçün InvokeAsync metodunu istifadə edirik
...
//        // IP siyahısında yoxdursa, bloklanır
