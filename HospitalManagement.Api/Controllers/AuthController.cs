...
namespace HospitalManagement.Api.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> MyInfo()
        {
            ...
            return Ok(new { doctor.Id, doctor.Name, doctor.Education,doctor.Birthday,doctor.Gender,doctor.Surname, doctor.Age, doctor.Phone, doctor.Salary, doctor.Email, doctor.FIN, doctor.Series, doctor.Address, doctor.Department.DepartmentName, doctor.CreatedTime });
        }
